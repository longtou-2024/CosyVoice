...
IMAGE_URL = "us-central1-docker.pkg.dev/prod-ai-project/tts/cosyvoice:v15.28"
N_GPU = 2
N_CPU = "10"
MEM_SIZE = "200Gi"
MOUNT_PATH = "/home/longtou.2024/mount"
MODEL_DIR = f"{MOUNT_PATH}/longtou/h100/exp/cosyvoice/20250915"
...
&& . ../../../activate_python.sh \
&& ./run.sh --stage 1 --stop_stage 1 --model_dir {MODEL_DIR} --tensorboard_dir {TB_DIR} --conf {CONFIG} --from_mount true --from_prod true --train_data "gs://literature commbooks skt_emotion_large mediazen mediazen_emotion emilia_yodas_ko aihub_news skt_emotion_small mediazen_adult mediazen_teen saltlux_jeju saltlux_chungcheong saltlux_gyeongsang saltlux_jeolla saltlux_gangwon saltlux_expert solugate speechlabs ku_old libritts_r emilia_yodas_en mls_en"
'''
