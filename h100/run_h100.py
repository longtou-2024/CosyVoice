...
IMAGE_URL = "us-central1-docker.pkg.dev/prod-ai-project/tts/cosyvoice:v3.6"
N_GPU = 4
N_CPU = "40"
MEM_SIZE = "400Gi"
MOUNT_PATH = "/home/longtou.2024/mount"
MODEL_DIR = f"{MOUNT_PATH}/longtou/h100/exp/cosyvoice/20250704"
...
&& . ../../../activate_python.sh \
&& ./run.sh --stage 1 --stop_stage 1 --model_dir {MODEL_DIR} --tensorboard_dir {TB_DIR} --conf {CONFIG} --from_mount true --from_prod true --train_data "gs://literature commbooks whispering mediazen_teen_laugh mediazen_adult_laugh mediazen"
'''
