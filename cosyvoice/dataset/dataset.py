...
class WebDataList(IterableDataset):
    ...
    def __init__(self, recipe_names, mode="train", cache_size=0, from_mount=False, from_prod=False):
        ...
        for name in recipe_names:
            ...
            elif name in ("literature", "commbooks", "skt_emotion_large", "mediazen_emotion"):
                ds1.append(build_wds(name, mode=mode, cache_size=cache_size, from_mount=from_mount, from_prod=from_prod))

            elif name in ("mediazen", "emilia_yodas_ko", "aihub_news", "skt_emotion_small", "mediazen_adult", "mediazen_teen", "saltlux_jeju", "saltlux_chungcheong", "saltlux_gyeongsang", "saltlux_jeolla", "saltlux_gangwon", "saltlux_expert", "solugate", "speechlabs", "ku_old", "mediazen_teen_laugh", "mediazen_adult_laugh"):
        ...
        if len(ds0) == 1:
            ...
            dataset = wds.RandomMix([ds1, ds2], probs=[80,20], longest=True)
