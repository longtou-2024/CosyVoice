...
for i, j in enumerate(cosyvoice.inference_zero_shot("<whisper>" + this_text + "</whisper>", "<neutral>" + azure_sent + "</neutral>", prompt_speech_16k, stream=False, text_frontend=False)):
...
#for i, j in enumerate(cosyvoice.inference_zero_shot("<neutral>" + pad_tag(this_text, ("<fast>", "</fast>")) + "</neutral>", "<neutral>" + azure_sent + "</neutral>", prompt_speech_16k, stream=False, text_frontend=False)):
#    torchaudio.save(f"{outdir}/{fout_names[8]}", j['tts_speech'], cosyvoice.sample_rate)
#for i, j in enumerate(cosyvoice.inference_zero_shot("<neutral>" + pad_tag(this_text, ("<slow>", "</slow>")) + "</neutral>", "<neutral>" + azure_sent + "</neutral>", prompt_speech_16k, stream=False, text_frontend=False)):
...
#for i, j in enumerate(cosyvoice.inference_instruct2("<whisper>" + this_text + "</whisper>", "", prompt_speech_16k, stream=False, text_frontend=False)):
#    torchaudio.save(f"{outdir}/{fout_names[10]}", j['tts_speech'], cosyvoice.sample_rate)
