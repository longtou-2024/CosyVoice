...
fout_names = ["base.wav", "happy.wav", "happy1.wav", "happy2.wav", "happy3.wav",
              "sad.wav", "sad1.wav", "sad2.wav", "sad3.wav",
              "angry.wav", "angry1.wav", "angry2.wav", "angry3.wav",
              "hurry.wav", "hurry1.wav", "hurry2.wav", "hurry3.wav",
              "anxious.wav", "anxious1.wav", "anxious2.wav", "anxious3.wav",
              ]
...
for i, j in enumerate(cosyvoice.inference_zero_shot(prefix_tag("happy", this_text), prompt_sent, prompt_speech_16k, stream=False, text_frontend=False)):
    torchaudio.save(f"{outdir}/{fout_names[1]}", j['tts_speech'], cosyvoice.sample_rate)
for i, j in enumerate(cosyvoice.inference_zero_shot(prefix_tag("happy 1", this_text), prompt_sent, prompt_speech_16k, stream=False, text_frontend=False)):
    torchaudio.save(f"{outdir}/{fout_names[2]}", j['tts_speech'], cosyvoice.sample_rate)
for i, j in enumerate(cosyvoice.inference_zero_shot(prefix_tag("happy 2", this_text), prompt_sent, prompt_speech_16k, stream=False, text_frontend=False)):
...
for i, j in enumerate(cosyvoice.inference_zero_shot(prefix_tag("sad", this_text), prompt_sent, prompt_speech_16k, stream=False, text_frontend=False)):
    torchaudio.save(f"{outdir}/{fout_names[5]}", j['tts_speech'], cosyvoice.sample_rate)
for i, j in enumerate(cosyvoice.inference_zero_shot(prefix_tag("sad 1", this_text), prompt_sent, prompt_speech_16k, stream=False, text_frontend=False)):
    torchaudio.save(f"{outdir}/{fout_names[6]}", j['tts_speech'], cosyvoice.sample_rate)
for i, j in enumerate(cosyvoice.inference_zero_shot(prefix_tag("sad 2", this_text), prompt_sent, prompt_speech_16k, stream=False, text_frontend=False)):
...
for i, j in enumerate(cosyvoice.inference_zero_shot(prefix_tag("angry", this_text), prompt_sent, prompt_speech_16k, stream=False, text_frontend=False)):
    torchaudio.save(f"{outdir}/{fout_names[9]}", j['tts_speech'], cosyvoice.sample_rate)
for i, j in enumerate(cosyvoice.inference_zero_shot(prefix_tag("angry 1", this_text), prompt_sent, prompt_speech_16k, stream=False, text_frontend=False)):
    torchaudio.save(f"{outdir}/{fout_names[10]}", j['tts_speech'], cosyvoice.sample_rate)
for i, j in enumerate(cosyvoice.inference_zero_shot(prefix_tag("angry 2", this_text), prompt_sent, prompt_speech_16k, stream=False, text_frontend=False)):
...
for i, j in enumerate(cosyvoice.inference_zero_shot(prefix_tag("hurry 1", this_text), prompt_sent, prompt_speech_16k, stream=False, text_frontend=False)):
    torchaudio.save(f"{outdir}/{fout_names[14]}", j['tts_speech'], cosyvoice.sample_rate)
for i, j in enumerate(cosyvoice.inference_zero_shot(prefix_tag("hurry 2", this_text), prompt_sent, prompt_speech_16k, stream=False, text_frontend=False)):
    torchaudio.save(f"{outdir}/{fout_names[15]}", j['tts_speech'], cosyvoice.sample_rate)
for i, j in enumerate(cosyvoice.inference_zero_shot(prefix_tag("hurry 3", this_text), prompt_sent, prompt_speech_16k, stream=False, text_frontend=False)):
...
for i, j in enumerate(cosyvoice.inference_zero_shot(prefix_tag("anxious 1", this_text), prompt_sent, prompt_speech_16k, stream=False, text_frontend=False)):
    torchaudio.save(f"{outdir}/{fout_names[18]}", j['tts_speech'], cosyvoice.sample_rate)
for i, j in enumerate(cosyvoice.inference_zero_shot(prefix_tag("anxious 2", this_text), prompt_sent, prompt_speech_16k, stream=False, text_frontend=False)):
    torchaudio.save(f"{outdir}/{fout_names[19]}", j['tts_speech'], cosyvoice.sample_rate)
for i, j in enumerate(cosyvoice.inference_zero_shot(prefix_tag("anxious 3", this_text), prompt_sent, prompt_speech_16k, stream=False, text_frontend=False)):
